...
编号规则的权威位置是 [artifact-routing](../skills/heuristic-testing/references/artifact-routing.md#统一编号与追溯)。项目覆盖节点用 N-001，风险用 R-001，测试项用 T-001，具体用例用 C-001。业务分类与 M／F／Q 类型写在标题或字段里，不各自重新编号。
